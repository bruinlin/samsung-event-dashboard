...
with seed(event_id, workstream_id, baseline_status, baseline_due_date, baseline_owner) as (values
  ...
  ('ODX_2026','ODX26-WS-03','Not Started','2026-08-26'::date,'Bruin & Leo'),
  ...
  ('ODX_2026','ODX26-WS-07','Not Started',null::date,'Seloma'),
  ('ODX_2026','ODX26-WS-08','Not Started','2026-09-02'::date,'Iris & Christy'),
  ('ODX_2026','ODX26-WS-09','Not Started',null::date,'Bruin'),
  ('ICCAD_2026','ICCAD26-WS-01','Not Started',null::date,'TBD'),
  ('ICCAD_2026','ICCAD26-WS-02',null,null::date,'TBD'),
  ('ICCAD_2026','ICCAD26-WS-03','Not Started',null::date,'TBD'),
  ('ICCAD_2026','ICCAD26-WS-04',null,null::date,'TBD'),
  ('ICCAD_2026','ICCAD26-WS-05','Not Started',null::date,'TBD'),
  ('ICCAD_2026','ICCAD26-WS-06','In Progress',null::date,'TBD'),
  ('ICCAD_2026','ICCAD26-WS-07','Not Started',null::date,'TBD'),
  ('ICCAD_2026','ICCAD26-WS-08','Not Started',null::date,'TBD'),
  ('ICCAD_2026','ICCAD26-WS-09','Not Started',null::date,'TBD'),
  ('ICCAD_2026','ICCAD26-WS-10',null,null::date,'TBD'),
  ('ICCAD_2026','ICCAD26-WS-11','Not Started',null::date,'TBD'),
...
with seed(event_id, workstream_id, stage_id, baseline_status, baseline_due_date, baseline_owner, baseline_completed_date) as (values
  ...
  ('ODX_2026','ODX26-WS-03','initial-draft','Not Started','2026-08-10'::date,'Bruin & Leo',null::date),
  ('ODX_2026','ODX26-WS-03','first-washing','Not Started','2026-08-14'::date,'Bruin & Leo',null::date),
  ('ODX_2026','ODX26-WS-03','internal-review','Not Started','2026-08-19'::date,'Bruin & Leo',null::date),
  ('ODX_2026','ODX26-WS-03','second-revision','Not Started','2026-08-24'::date,'Bruin & Leo',null::date),
  ('ODX_2026','ODX26-WS-03','final-approval','Not Started','2026-08-26'::date,'Bruin & Leo',null::date),
  ('ODX_2026','ODX26-WS-07','planning-draft','Not Started','2026-08-19'::date,'Seloma',null::date),
  ('ICCAD_2026','ICCAD26-WS-02','presenter-confirmation','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-02','topic-confirmation','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-02','initial-draft','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-02','internal-review','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-02','final-approval','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-02','rehearsal','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-04','design-brief','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-04','initial-design','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-04','review-revision','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-04','final-artwork','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-04','onsite-completion','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-10','planning-draft','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-12','data-collection','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-12','report-draft','Not Started',null::date,'TBD',null::date),
  ('ICCAD_2026','ICCAD26-WS-12','final-report','Not Started',null::date,'TBD',null::date)
)
